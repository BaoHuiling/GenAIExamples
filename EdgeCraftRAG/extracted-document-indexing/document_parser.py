"""
Document Parser for extracting and chunking documents
Supports: TXT, PDF, DOCX, PPT, and other formats
"""
...
from utils import DocxParagraphPicturePartitioner, ensure_directory, is_supported_file
...
class DocumentParser:
    ...
    def __init__(
        ...
        # Metadata to exclude from embeddings and LLM context
    ...
    def parse_file(self, file_path: str) -> List[BaseNode]:
        ...
        # Register custom DOCX image partitioner
        register_picture_partitioner(DocxParagraphPicturePartitioner)

        # Build unstructured kwargs
        unstructured_kwargs = {
